...
@AllArgsConstructor
@Builder
public class OrderRefundDeclinedEvent implements NotificationEvent {
    private Refund refund;
    private String eventId;

    @Override
    public NotificationType getType() {
        return NotificationType.ORDER_REFUND_DECLINED;
    }
    ...
    public String getEventId() {
        return eventId != null ? eventId : "REFUND_DECLINED_" + refund.getId();
    }
}