...
@AllArgsConstructor
@Builder
public class CartProductStatusChangedEvent implements NotificationEvent {
    ...
    public NotificationType getType() {
        return NotificationType.CART_PRODUCT_STATUS_CHANGED;
    }
    ...
    public String getEventId() {
        return eventId != null ? eventId : "CART_PRODUCT_STATUS_" + product.getId();
    }
}